 ...
 */
/** Téléphone optionnel : format permissif (chiffres, +, espaces, séparateurs). Vide → undefined. */
...
/** Première connexion / création de compte : prénom + nom + email + téléphone optionnel. */
